    ...
    <form method="POST" action="salvar-projeto.php" enctype="multipart/form-data">
      ...
      <section class="secao-conteudo">
        ...
        <div class="cards-container">
          <div class="content-card" id="fotos-card">
            ...
            <button class="restore-button" onclick="minimizeCard('fotos-card')">Restaurar</button>
          </div>
          <div class="content-card" id="videos-card">
            ...
            <button class="restore-button" onclick="minimizeCard('videos-card')">Restaurar</button>
          </div>
          <div class="content-card" id="curta-card">
            ...
            <button class="restore-button" onclick="minimizeCard('curta-card')">Restaurar</button>
          </div>
        </div>
      </section>
      ...
      <section class="secao-habilidades">
        ...
        <textarea
          ...
          class="textarea-habilidades"></textarea>
      </section>
